terraform {
  ...
  # backend "http" {
  #   address        = "https://srvottgitlab02.rossvideo.com/api/v4/projects/525/terraform/state/demo4"
  #   lock_address   = "https://srvottgitlab02.rossvideo.com/api/v4/projects/525/terraform/state/demo4/lock"
  #   unlock_address = "https://srvottgitlab02.rossvideo.com/api/v4/projects/525/terraform/state/demo4/lock"
  #   lock_method    = "POST"
  #   unlock_method  = "DELETE"
  #   retry_wait_min = 5
  # }
