...
resource "docker_container" "madden_bowl_ts2mxl_container" {
  name  = "madden_bowl_ts2mxl_container"
...
resource "catena_device" "madden_bowl_ts2mxl" {
  depends_on = [ docker_container.madden_bowl_ts2mxl_container ]
  ...
  apply_all = false
  params_map = {
    "/inputs/ts_file_path"  = "/ts/Madden_Bowl.ts"
